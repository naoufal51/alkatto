...
class InputState:
    ...
    human_analyst_feedback: str = field(default="")
    """Feedback from human analyst on the research plan."""
...
class AgentState(InputState):
    ...
    steps_research: list[str] = field(default_factory=list)
    """Steps for the research path."""
    
    # steps_finder: list[str] = field(default_factory=list)
    # """Steps for the finder path."""
